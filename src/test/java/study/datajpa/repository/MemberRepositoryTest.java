...
public class MemberRepositoryTest {
    ...
    public void basicCRUD(){
        ...
        findMember1.setUsername("member111111");
...
//        //삭제 검증
    ...
    public void returnType() {
        ...
        Optional<Member> aaa = memberRepository.findOptionalByUsername("AAAa");
        if (!aaa.isPresent()) {
...
//        em.clear();
        ...
        //벌크시 DB에는 반영이 되어있지만 영속성 컨테스트에는 반영이 안되어있는 경우
